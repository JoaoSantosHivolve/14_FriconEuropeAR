...
public class ManipulationSystem : MonoBehaviour
{
    ...
    internal void Select(GameObject target)
    {
        ...
        // Update object manipulation hud selected color on pallet
        var selectedColor = SelectedObject.GetComponent<Manipulator>().materialController.selectedColor;
        colorPalletAnimationController.OnClick(selectedColor);
    }
