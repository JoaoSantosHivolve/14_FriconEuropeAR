...
namespace GoogleARCore.Examples.ObjectManipulation
{
    ...
    public abstract class Manipulator : MonoBehaviour
    {
        ...
        [HideInInspector] public FridgeMaterialController materialController;
        ...
        private static bool IsPointerOverUiObject(TapGesture gesture)
        {
            ...
            eventDataCurrentPosition.position = new Vector2(gesture.StartPosition.x, gesture.StartPosition.y);
